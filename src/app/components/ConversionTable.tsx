...
const uploadFormats = ["PNG", "JPEG", "WEBP", "GIF", "BMP", "ICO", "HEIC", "HEIF"];
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-10">
      ...
      <p className="text-center text-gray-600 mb-6">
        Below are the supported image format conversions available in Quick Convert.
      </p>
      ...
      <div className="mt-6 text-sm text-gray-700 bg-yellow-100 p-4 rounded-lg shadow-sm">
        ...
        <ul className="list-disc list-inside">
          <li>
            HEIC and HEIF formats may take longer to process due to additional decoding requirements.
          </li>
          <li>
            This software is compatible with mobile devices, but due to lower processing power,
            conversions may take longer. High file size or bulk conversions may cause instability,
            except on high-end devices.
          </li>
        </ul>
      </div>
    </section>
